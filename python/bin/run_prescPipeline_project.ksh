...
# Script Name: run_prescPipeline_project.ksh                   #
# PURPOSE: Master Script to run the entire project end to end. #
################################################################

PROJ_FOLDER="/home/${USER}/PrescriberPipeline/main/src/python"
...
spark-submit --master yarn --num-executors 28 --jars ${PROJ_FOLDER}/lib/postgresql-42.3.5.jar run_presc_pipeline.py
